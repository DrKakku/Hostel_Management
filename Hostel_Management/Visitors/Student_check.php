...
if ($students[0]["Student_ID"] == $roll) { 
	...
	print_r($GLOBALS);
    header('Location: /Hostel_Management/Visitors/Visitors.php');
} 
}else 
{ 
...
<section class="container grey-text">
	...
	<form class="light-green lighten-4   " action="/Hostel_Management/Visitors/Student_check.php/" meathod="GET">
